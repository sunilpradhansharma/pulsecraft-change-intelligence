"""run-change command — drive a ChangeArtifact through the pipeline."""
...
def register(app: typer.Typer) -> None:
    ...
    def run_change(
        ...
        """Drive a ChangeArtifact through the full pipeline.

        Uses mock agents by default (no LLM calls). Pass --real-* flags to use
        the LLM-backed agents for individual stages.
        """
        import json
